        ...
        "../../controllers/tipo.membresia.controller.php?op=todos", {}, (listamembresias) => {
            ...
            $.each(listamembresias, (index, membresia) => {
                html +=
                    ...
                    `<td>` +
                    `<button class='btn btn-success' onclick='uno(${membresia.tipo_id})'>Editar</button>` +
                    `<button class='btn btn-danger' onclick='eliminar(${membresia.tipo_id})'>Eliminar</button>` +
                    `</td>` +
                    `</tr>`;
            });
